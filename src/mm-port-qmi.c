...
#if defined WITH_NEWEST_WDA_DATA_FORMATS
    /* Some modems support the new data formats, but not the old ones, skip these for now */
    { MM_PORT_QMI_KERNEL_DATA_MODE_802_3,       QMI_WDA_LINK_LAYER_PROTOCOL_802_3, QMI_WDA_DATA_AGGREGATION_PROTOCOL_TLP },
